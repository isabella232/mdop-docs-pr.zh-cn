---
title: 如何使用 PowerShell 脚本创建恢复映像
description: 如何使用 PowerShell 脚本创建恢复映像
author: dansimp
...
ms.locfileid: "10803258"
---
# <span data-ttu-id="fdc9e-103">如何使用 PowerShell 脚本创建恢复映像</span><span class="sxs-lookup"><span data-stu-id="fdc9e-103">How to Use a PowerShell Script to Create the Recovery Image</span></span>


## <a href="" id="bkmk-create-image-use-script"></a><span data-ttu-id="fdc9e-104">使用 PowerShell 脚本创建 DaRT 恢复映像</span><span class="sxs-lookup"><span data-stu-id="fdc9e-104">To create the DaRT recovery image by using a PowerShell script</span></span>


<span data-ttu-id="fdc9e-105">你可以使用 PowerShell 脚本（而不是使用 DaRT 8.0 恢复映像向导）创建 Microsoft 诊断和恢复工具集（DaRT）8.0 恢复映像。</span><span class="sxs-lookup"><span data-stu-id="fdc9e-105">You can create the Microsoft Diagnostics and Recovery Toolset (DaRT) 8.0 recovery image by using a PowerShell script instead of using the DaRT 8.0 Recovery Image wizard.</span></span> <span data-ttu-id="fdc9e-106">请参阅以下示例脚本。</span><span class="sxs-lookup"><span data-stu-id="fdc9e-106">See the following example script.</span></span>
...
`Import-Module "Dism"`<span data-ttu-id="fdc9e-107">I</span><span class="sxs-lookup"><span data-stu-id="fdc9e-107">I</span></span>`mport-Module "Microsoft.Dart"`
...
## <span data-ttu-id="fdc9e-108">相关主题</span><span class="sxs-lookup"><span data-stu-id="fdc9e-108">Related topics</span></span>


[<span data-ttu-id="fdc9e-109">使用 PowerShell 管理 DaRT 8.0</span><span class="sxs-lookup"><span data-stu-id="fdc9e-109">Administering DaRT 8.0 Using PowerShell</span></span>](administering-dart-80-using-powershell-dart-8.md)
