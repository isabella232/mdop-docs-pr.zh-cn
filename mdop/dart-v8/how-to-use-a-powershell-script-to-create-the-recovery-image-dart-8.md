...
---
# 如何使用 PowerShell 脚本创建恢复映像


## <a href="" id="bkmk-create-image-use-script"></a>使用 PowerShell 脚本创建 DaRT 恢复映像


你可以使用 PowerShell 脚本（而不是使用 DaRT 8.0 恢复映像向导）创建 Microsoft 诊断和恢复工具集（DaRT）8.0 恢复映像。 请参阅以下示例脚本。
