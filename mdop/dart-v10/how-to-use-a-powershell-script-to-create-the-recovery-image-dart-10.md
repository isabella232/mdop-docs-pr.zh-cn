...
ms.locfileid: "10803243"
---
# <span data-ttu-id="496d7-103">如何使用 PowerShell 脚本创建恢复映像</span><span class="sxs-lookup"><span data-stu-id="496d7-103">How to Use a PowerShell Script to Create the Recovery Image</span></span>


## <a href="" id="bkmk-create-image-use-script"></a><span data-ttu-id="496d7-104">使用 PowerShell 脚本创建 DaRT 恢复映像</span><span class="sxs-lookup"><span data-stu-id="496d7-104">To create the DaRT recovery image by using a PowerShell script</span></span>


<span data-ttu-id="496d7-105">你可以使用 PowerShell 脚本（而不是使用 DaRT 10 恢复映像向导）创建 Microsoft 诊断和恢复工具集（DaRT）10恢复映像。</span><span class="sxs-lookup"><span data-stu-id="496d7-105">You can create the Microsoft Diagnostics and Recovery Toolset (DaRT) 10 recovery image by using a PowerShell script instead of using the DaRT 10 Recovery Image wizard.</span></span> <span data-ttu-id="496d7-106">请参阅以下示例脚本。</span><span class="sxs-lookup"><span data-stu-id="496d7-106">See the following example script.</span></span>
...
`Import-Module "Dism"`<span data-ttu-id="496d7-107">I</span><span class="sxs-lookup"><span data-stu-id="496d7-107">I</span></span>`mport-Module "Microsoft.Dart"`
...
## <span data-ttu-id="496d7-108">相关主题</span><span class="sxs-lookup"><span data-stu-id="496d7-108">Related topics</span></span>


[<span data-ttu-id="496d7-109">使用 PowerShell 管理 DaRT 10</span><span class="sxs-lookup"><span data-stu-id="496d7-109">Administering DaRT 10 Using PowerShell</span></span>](administering-dart-10-using-powershell.md)
