...
本主题指定在你的环境中安装和运行 Microsoft 诊断和恢复工具集（DaRT）10所需的必备软件和支持的配置要求。 将指定运行 DaRT 10 所需的操作系统要求和系统要求。 有关创建 DaRT 恢复映像时需要考虑的先决条件的信息，请参阅[规划以创建 dart 10 恢复映像](planning-to-create-the-dart-10-recovery-image.md)。
...
下表列出了安装 DaRT 10 和所有 DaRT 工具时管理员计算机的安装先决条件。
...
<td align="left"><p>崩溃分析器需要 windows 驱动程序工具包中的 Windows 10 调试工具来分析内存转储文件。</p></td>
</tr>
<tr class="odd">
<td align="left"><p><strong>Windows 10 64 位或32位 ISO 镜像</strong></p></td>
<td align="left"><p>DaRT 需要 windows 10 介质中的 Windows 恢复环境（Windows RE）映像。 下载32位或64位版本的 Windows 10，具体取决于要创建的 DaRT 恢复映像的类型。 如果你在你的环境中支持这两种系统类型，请下载 Windows 10 的两个版本。</p></td>
</tr>
</tbody>
</table>
...
下表列出了运行 DaRT 10 远程连接查看器时帮助台计算机的安装先决条件。
...
<tbody>
<tr class="odd">
<td align="left"><p><strong>DaRT 10 远程连接查看器</strong></p></td>
<td align="left"><p>必须在 Windows 10 操作系统上安装。</p></td>
</tr>
<tr class="even">
...
除了 Windows 10 操作系统之外，不存在必须安装在最终用户计算机上的必备软件。

## <a href="" id="---------dart-10-operating-system-requirements"></a> DaRT 10 操作系统要求


### 管理员计算机系统要求

下表列出了 DaRT 10 管理员计算机安装支持的操作系统。
...
DaRT 10 使技术支持人员能够使用 DaRT 7.0、DaRT 8.0、DaRt 8.1 或 DaRT 10 远程连接查看器连接到 DaRT 10 计算机。 DaRT 7.0、DaRT 8.0 和 DaRt 8.1、远程连接查看器分别需要 Windows 7、Windows 8 或 Windows 8.1 操作系统，而 DaRT 10 远程连接查看器需要 Windows 10。 DaRT 10 远程连接查看器和所有其他 DaRT 10 工具只能安装在运行 Windows 10 的计算机上。
...
<tr class="even">
<td align="left"><p>Windows10 （仅限远程连接查看器10.0）</p></td>
<td align="left"><p>所有版本</p></td>
<td align="left"><p>不适用</p></td>
<td align="left"><p>32 位</p></td>
<td align="left"><p>1 GB</p></td>
...
### <a href="" id="-------------dart-10-end-user-computer-system-requirements"></a> DaRT 10 最终用户计算机系统要求

DaRT 10 中的 "诊断和恢复工具集" 窗口要求最终用户计算机使用下列操作系统之一以及可用于 DaRT 的指定系统内存量：
