...
如果您使用的是 SystemCenter2012 ConfigurationManager，则必须创建该文件。 在顶级网站上创建文件。 这些更改将复制到你的基础结构中的其他网站。
...
3.  修改**Win32 \ _Tpm**类，如下所示：
    ...
    已**获得 MBAM 的建议**？ 在[此处](http://mbam.uservoice.com/forums/268571-microsoft-bitlocker-administration-and-monitoring)添加或投票建议。 **遇到 MBAM 问题**？ 使用[MBAM TechNet 论坛](https://social.technet.microsoft.com/Forums/home?forum=mdopmbam)。
