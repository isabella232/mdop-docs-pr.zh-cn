...
<td align="left"><p>当应用 Application Virtualization 5.0 连接组文件时，文件中枚举的程序包将在运行时合并到单个虚拟环境中。 使用 Microsoft Application Virtualization （App-v）5.0 连接组文件配置现有应用程序虚拟化5.0 连接组。</p></td>
</tr>
<tr class="odd">
...
-   [App-v 5.0 SP3 示例连接组 XML 文件](#bkmk-50sp3-exp-cg-xml)
...
<p>了解 <a href="how-to-use-optional-packages-in-connection-groups.md" data-raw-source="[How to Use Optional Packages in Connection Groups](how-to-use-optional-packages-in-connection-groups.md)"> 如何在连接组中使用可选程序包 </a> 。</p></td>
</tr>
</tbody>
</table>
...
### <a href="" id="bkmk-50sp3-exp-cg-xml"></a>App-v 5.0 SP3 示例连接组 XML 文件

以下示例连接组 XML 文件显示了上表中的字段示例，并突出显示了 App-v 5.0 SP3 的新项。
