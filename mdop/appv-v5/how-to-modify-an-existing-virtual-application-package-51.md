...
-   确保已安装了 Microsoft Application Virtualization （App-v） Sequencer，这是修改虚拟应用程序包所必需的。 若要安装 app-v 排序器，请参阅[如何安装 Sequencer](how-to-install-the-sequencer-51beta-gb18030.md)。
