...
在安装 Microsoft Application Virtualization （App-v） 5.0 SP3 之前，请确保已安装以下所有必需的必备软件。

有关支持的操作系统和 app-v Server、Sequencer 和客户端的硬件要求的列表，请参阅[app-v 5.0 SP3 支持的配置](app-v-50-sp3-supported-configurations.md)。
...
为 App-v 5.0 SP3 服务器组件安装所需的必备软件。
...
<td align="left"><ul>
<li><p>在运行 app-v 的任何以前版本或组件的计算机上安装 app-v 服务器。</p></li>
...
<td align="left"><p>有关支持的版本，请参阅 <a href="app-v-50-sp3-supported-configurations.md" data-raw-source="[App-V 5.0 SP3 Supported Configurations](app-v-50-sp3-supported-configurations.md)"> App-V 5.0 SP3 支持 </a> 的配置。</p></td>
</tr>
<tr class="even">
...
<td align="left"><p>只有安装了 Silverlight，管理控制台才可用。</p></td>
</tr>
</tbody>
</table>
...
只有在使用 App-v 5.0 SP3 管理服务器时，才需要管理数据库。
...
只有在使用 App-v 5.0 SP3 报告服务器时，才需要报告数据库。
...
-   排序过程占用大量资源，因此请确保运行排序器的计算机具有大量内存、快速处理器和快速硬盘。 本地安装的应用程序的系统要求不能超过 Sequencer 的系统要求。 有关详细信息，请参阅[App-V 5.0 支持的配置](app-v-50-supported-configurations.md)。
