...
-   [用于查看发布元数据的 app-v 5.1 要求](#bkmk-51-reqs-pub-meta)
...
## <a href="" id="bkmk-51-reqs-pub-meta"></a>用于查看发布元数据的 app-v 5.1 要求


在 App-v 5.1 中，当你查询用于元数据的 app-v 发布服务器时，必须在地址中提供以下值：
...
<td align="left"><p>如果省略查询中的 <strong> ClientVersion </strong> 参数，元数据将排除 APP-V 5.0 SP3 中新增的功能。</p></td>
</tr>
<tr class="even">
...
<div class="alert">
<strong>注意</strong><br/><p><strong>ClientVersion </strong> 和 <strong> ClientOS </strong> 仅在 app-v 5.0 SP3 和 app-v 5.1 中受支持。</p>
</div>
<div>

</div></td>
<td align="left"><p>请参阅应用-V 5.0 SP3 和 App-v 5.1 的信息。</p></td>
